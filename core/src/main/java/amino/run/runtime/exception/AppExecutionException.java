 ...
 *
 * <p>This exception is caused by application errors, not MicroService errors. It indicates
 * something wrong in application. Good applications should <em>not</em> cause this exception on
 * method invocations.
 *
 * @author terryz
 */
