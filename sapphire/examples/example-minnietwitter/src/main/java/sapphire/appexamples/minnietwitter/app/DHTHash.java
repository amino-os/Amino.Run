...
public class DHTHash {
	...
	public static void setFunction(String function) {
		if (function.equals("CRC32")) {
			sapphire.policy.dht.DHTHash.KEY_LENGTH = 64;
		}
		if (function.equals("Java")) {
			sapphire.policy.dht.DHTHash.KEY_LENGTH = 32;
		}
		sapphire.policy.dht.DHTHash.function = function;
	}
