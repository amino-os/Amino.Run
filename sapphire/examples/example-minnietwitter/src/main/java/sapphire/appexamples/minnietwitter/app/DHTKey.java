...
public class DHTKey implements Comparable, Serializable {
	...
	public boolean isBetween(sapphire.policy.interfaces.dht.DHTKey fromKey, sapphire.policy.interfaces.dht.DHTKey toKey) {
	...
	public sapphire.policy.interfaces.dht.DHTKey createStartKey(int index) {
		...
		return new sapphire.policy.interfaces.dht.DHTKey(newKey);
	}

	@Override
	public boolean equals(Object obj) {
		sapphire.policy.interfaces.dht.DHTKey another = (sapphire.policy.interfaces.dht.DHTKey) obj;
	...
	public int compareTo(Object obj) {
		sapphire.policy.interfaces.dht.DHTKey targetKey = (sapphire.policy.interfaces.dht.DHTKey) obj;
