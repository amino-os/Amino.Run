/*
 * Stub for class hw.demo.wallet
 * Generated by Sapphire Compiler (sc).
 */
package hw.demo.stubs;


public final class wallet_Stub extends hw.demo.wallet implements sapphire.common.AppObjectStub {
    ...
    public sapphire.policy.transaction.TransactionManager.Vote vote(java.util.UUID $param_UUID_1)
        ...
        try {
            if ($__directInvocation)
                ...
                String $__method = "public sapphire.policy.transaction.TransactionManager$Vote hw.demo.wallet.vote(java.util.UUID) throws sapphire.policy.transaction.TransactionExecutionException";
    ...
    public void leave(java.util.UUID $param_UUID_1) {
        ...
        try {
            if ($__directInvocation)
                ...
                java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
                String $__method = "public void hw.demo.wallet.leave(java.util.UUID)";
                $__params.add($param_UUID_1);
                $__result = $__client.onRPC($__method, $__params);
            }
        } catch (Exception e) {
    ...
    public void join(java.util.UUID $param_UUID_1)
        ...
        try {
            if ($__directInvocation)
                ...
                java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
                String $__method = "public void hw.demo.wallet.join(java.util.UUID) throws sapphire.policy.serializability.TransactionAlreadyStartedException";
                $__params.add($param_UUID_1);
                $__result = $__client.onRPC($__method, $__params);
            }
        } catch (Exception e) {
    ...
    public int getBalance() {
        ...
        try {
            if ($__directInvocation)
                ...
                java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
                String $__method = "public int hw.demo.wallet.getBalance()";
                $__result = $__client.onRPC($__method, $__params);
            }
        } catch (Exception e) {
            e.printStackTrace();
...
//        try {
            if ($__directInvocation)
                ...
                java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
                String $__method = "public void hw.demo.wallet.debit(int) throws java.lang.Exception";
    ...
    public void credit(int $param_int_1) {
        ...
        try {
            if ($__directInvocation)
                ...
                java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
                String $__method = "public void hw.demo.wallet.credit(int)";
                $__params.add($param_int_1);
                $__result = $__client.onRPC($__method, $__params);
            }
        } catch (Exception e) {
    ...
    public void commit(java.util.UUID $param_UUID_1) {
        ...
        try {
            if ($__directInvocation)
                ...
                java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
                String $__method = "public void hw.demo.wallet.commit(java.util.UUID)";
                $__params.add($param_UUID_1);
                $__result = $__client.onRPC($__method, $__params);
            }
        } catch (Exception e) {
    ...
    public void abort(java.util.UUID $param_UUID_1) {
        ...
        try {
            if ($__directInvocation)
                ...
                java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
                String $__method = "public void hw.demo.wallet.abort(java.util.UUID)";
                $__params.add($param_UUID_1);
                $__result = $__client.onRPC($__method, $__params);
            }
        } catch (Exception e) {
