...
public class Client {
    public static void main(String... args){
        ...
        Test(hostIp, hostPort, omsIp, omsPort, sapphire.app.Language.js, "HanksTodoJS.yaml");
    ...
    private static void Test(String hostIp, String hostPort, String omsIp, String omsPort, sapphire.app.Language lang, String fileName) {
        ...
        try {
            tls = sapphire.appexamples.hankstodo.stubs.TodoListManager_Stub.getStub(fileName,
