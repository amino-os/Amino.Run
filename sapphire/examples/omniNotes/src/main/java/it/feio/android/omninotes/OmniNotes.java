...
public class OmniNotes extends MultiDexApplication implements Serializable {
	...
	public AnalyticsHelper getAnalyticsHelper() {
		if (analyticsHelper == null) {
			...
			try {
				// todo: set PARAMS properly String[] analyticsParams = BuildConfig.ANALYTICS_PARAMS.split(Constants.PROPERTIES_PARAMS_SEPARATOR);
				String params = "";
				String[] analyticsParams = params.split(Constants.PROPERTIES_PARAMS_SEPARATOR);
