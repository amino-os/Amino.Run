...
public class GraalStubGenerator {
    ...
    private static String codeStringFormat =
            "package %s;\n\n"
                    ...
                    + "\n"
                    + "    amino.run.policy.SapphirePolicy.SapphireClientPolicy $__client = null;\n"
                    ...
                    + "    public %s%s () {super();}\n"
                    + "\n"
                    + "    public void $__initialize(amino.run.policy.SapphirePolicy.SapphireClientPolicy client) {\n"
                    + "        $__client = client;\n"
                    + "    }\n"
                    + "\n"
                    ...
                    + "    }\n"
                    + "\n"
                    + "    public void $__initializeGraal(amino.run.app.SapphireObjectSpec spec, java.lang.Object[] params){\n"
                    + "        try {\n"
