...
/**
 * Created by quinton on 1/16/18. This interface must be implemented by all SO's that use
 * ExplicitCheckpointPoilcy. A convenience implementation (ExplicitCheckpointerImpl) is provided, so
