...
import amino.run.policy.scalability.masterslave.*;
...
import amino.run.policy.scalability.masterslave.LogEntry;
...
import amino.run.policy.scalability.masterslave.Processor;
            ...
            switch (this.stateMgr.getCurrentState().getName()) {
                case SLAVE:
                    return new MethodInvocationResponse(
                            MethodInvocationResponse.ReturnCode.REDIRECT, null);
