...
public class TransactionWrapper {
    ...
    public static final String txWrapperTag = "tx_rpc";
     ...
     *
     * @param method the rpc method name which indicates the call wrapped inside a transaxtion or
     *     not
     * @param params the rpc call parameters which may include the real rpc info inside of a
     *     transaction
     */
     ...
     */
    public static ArrayList<Object> getTransactionRPCParams(
            UUID transactionId, String method, ArrayList<Object> params) {
        ArrayList<Object> rpcOriginal = new ArrayList<Object>(Arrays.asList(method, params));
        ArrayList<Object> txnPayload =
                new ArrayList<Object>(Arrays.asList(transactionId, rpcOriginal));
        return txnPayload;
    }
