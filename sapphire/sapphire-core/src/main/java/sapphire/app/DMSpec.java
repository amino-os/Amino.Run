...
public final class DMSpec implements Serializable {
     ...
     *
     * <p>One sapphire policy usually has only one configuration. But in some cases, one sapphire
     * policy may have multiple configurations. For example, @{@link
     * sapphire.policy.scalability.ScaleUpFrontendPolicy} is a sub class of {@link
     * sapphire.policy.scalability.LoadBalancedFrontendPolicy} policy. Each of them has their own
