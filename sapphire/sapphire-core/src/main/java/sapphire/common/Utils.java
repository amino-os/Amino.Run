...
public class Utils {
        ...
        return new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    logger.log(Level.WARNING, String.format("got exception when execute runnable %s: %s", runnable, e), e);
    ...
    public static boolean isImmutableMethod(Class<?> clazz, String methodName, ArrayList<Object> params) {
        ...
        try {
            ...
            throw new IllegalStateException(String.format("unable to find method %s in %s with param types %s", methodName, clazz, paramTypes), e);
        }
    }
