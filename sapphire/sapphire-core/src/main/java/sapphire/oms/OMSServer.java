...
public interface OMSServer extends Remote {
       ...
       ArrayList<KernelServerInfo> getKernelServersInRegion(String region) throws RemoteException;
       KernelServer getKernelServer(InetSocketAddress host) throws RemoteException;
       void registerKernelServer(InetSocketAddress host) throws RemoteException, NotBoundException;
       void registerKernelServerWithRegion(String region, InetSocketAddress host) throws RemoteException, NotBoundException;
