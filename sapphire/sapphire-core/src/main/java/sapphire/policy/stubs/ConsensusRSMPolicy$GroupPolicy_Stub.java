/*
 * Stub for class sapphire.policy.replication.ConsensusRSMPolicy.GroupPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class ConsensusRSMPolicy$GroupPolicy_Stub extends sapphire.policy.replication.ConsensusRSMPolicy.GroupPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public ConsensusRSMPolicy$GroupPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        ConsensusRSMPolicy$GroupPolicy_Stub other = (ConsensusRSMPolicy$GroupPolicy_Stub) obj;
    ...
    public void onCreate(sapphire.policy.SapphirePolicy.SapphireServerPolicy $param_SapphirePolicy$SapphireServerPolicy_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.policy.replication.ConsensusRSMPolicy$GroupPolicy.onCreate(sapphire.policy.SapphirePolicy$SapphireServerPolicy)";
        $__params.add($param_SapphirePolicy$SapphireServerPolicy_1);
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
