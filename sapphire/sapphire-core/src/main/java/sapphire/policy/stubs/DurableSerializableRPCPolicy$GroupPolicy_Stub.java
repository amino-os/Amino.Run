/*
 * Stub for class sapphire.policy.checkpoint.durableserializable.DurableSerializableRPCPolicy.GroupPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class DurableSerializableRPCPolicy$GroupPolicy_Stub extends sapphire.policy.checkpoint.durableserializable.DurableSerializableRPCPolicy.GroupPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public DurableSerializableRPCPolicy$GroupPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        DurableSerializableRPCPolicy$GroupPolicy_Stub other = (DurableSerializableRPCPolicy$GroupPolicy_Stub) obj;
