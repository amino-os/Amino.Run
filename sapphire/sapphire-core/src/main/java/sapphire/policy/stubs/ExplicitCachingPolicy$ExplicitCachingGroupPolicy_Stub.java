/*
 * Stub for class sapphire.policy.cache.explicitcaching.ExplicitCachingPolicy.ExplicitCachingGroupPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class ExplicitCachingPolicy$ExplicitCachingGroupPolicy_Stub extends sapphire.policy.cache.explicitcaching.ExplicitCachingPolicy.ExplicitCachingGroupPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public ExplicitCachingPolicy$ExplicitCachingGroupPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        ExplicitCachingPolicy$ExplicitCachingGroupPolicy_Stub other = (ExplicitCachingPolicy$ExplicitCachingGroupPolicy_Stub) obj;
