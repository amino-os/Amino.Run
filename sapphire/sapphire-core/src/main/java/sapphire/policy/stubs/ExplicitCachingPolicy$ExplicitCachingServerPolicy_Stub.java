/*
 * Stub for class sapphire.policy.cache.explicitcaching.ExplicitCachingPolicy.ExplicitCachingServerPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class ExplicitCachingPolicy$ExplicitCachingServerPolicy_Stub extends sapphire.policy.cache.explicitcaching.ExplicitCachingPolicy.ExplicitCachingServerPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public ExplicitCachingPolicy$ExplicitCachingServerPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        ExplicitCachingPolicy$ExplicitCachingServerPolicy_Stub other = (ExplicitCachingPolicy$ExplicitCachingServerPolicy_Stub) obj;
    ...
    // Implementation of syncCopy(Serializable)
    public void syncCopy(java.io.Serializable $param_Serializable_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.policy.cache.explicitcaching.ExplicitCachingPolicy$ExplicitCachingServerPolicy.syncCopy(java.io.Serializable)";
    ...
    // Implementation of getCopy()
    public sapphire.common.AppObject getCopy() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public sapphire.common.AppObject sapphire.policy.cache.explicitcaching.ExplicitCachingPolicy$ExplicitCachingServerPolicy.getCopy()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
