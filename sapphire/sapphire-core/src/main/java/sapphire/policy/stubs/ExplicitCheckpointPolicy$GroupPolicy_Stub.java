/*
 * Stub for class sapphire.policy.checkpoint.explicitcheckpoint.ExplicitCheckpointPolicy.GroupPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class ExplicitCheckpointPolicy$GroupPolicy_Stub extends sapphire.policy.checkpoint.explicitcheckpoint.ExplicitCheckpointPolicy.GroupPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public ExplicitCheckpointPolicy$GroupPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        ExplicitCheckpointPolicy$GroupPolicy_Stub other = (ExplicitCheckpointPolicy$GroupPolicy_Stub) obj;
