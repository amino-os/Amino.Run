/*
 * Stub for class sapphire.policy.mobility.explicitmigration.ExplicitMigrationPolicy.ServerPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class ExplicitMigrationPolicy$ServerPolicy_Stub extends sapphire.policy.mobility.explicitmigration.ExplicitMigrationPolicy.ServerPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public ExplicitMigrationPolicy$ServerPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        ExplicitMigrationPolicy$ServerPolicy_Stub other = (ExplicitMigrationPolicy$ServerPolicy_Stub) obj;
    ...
    public java.lang.Object onRPC(java.lang.String $param_String_1, java.util.ArrayList $param_ArrayList_2)
        ...
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public java.lang.Object sapphire.policy.mobility.explicitmigration.ExplicitMigrationPolicy$ServerPolicy.onRPC(java.lang.String,java.util.ArrayList<java.lang.Object>) throws java.lang.Exception";
        $__params.add($param_String_1);
    ...
    public void migrateObject(java.net.InetSocketAddress $param_InetSocketAddress_1)
            throws java.lang.Exception {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.policy.mobility.explicitmigration.ExplicitMigrationPolicy$ServerPolicy.migrateObject(java.net.InetSocketAddress) throws java.lang.Exception";
        $__params.add($param_InetSocketAddress_1);
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
