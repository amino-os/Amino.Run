/*
 * Stub for class sapphire.policy.primitive.ImmutablePolicy.GroupPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class ImmutablePolicy$GroupPolicy_Stub extends sapphire.policy.primitive.ImmutablePolicy.GroupPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public ImmutablePolicy$GroupPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        ImmutablePolicy$GroupPolicy_Stub other = (ImmutablePolicy$GroupPolicy_Stub) obj;
