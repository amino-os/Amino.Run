/*
 * Stub for class sapphire.policy.primitive.ImmutablePolicy.ServerPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class ImmutablePolicy$ServerPolicy_Stub extends sapphire.policy.primitive.ImmutablePolicy.ServerPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public ImmutablePolicy$ServerPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        ImmutablePolicy$ServerPolicy_Stub other = (ImmutablePolicy$ServerPolicy_Stub) obj;
