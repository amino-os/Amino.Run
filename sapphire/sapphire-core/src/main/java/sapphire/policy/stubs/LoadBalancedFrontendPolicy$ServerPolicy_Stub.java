/*
 * Stub for class sapphire.policy.scalability.LoadBalancedFrontendPolicy.ServerPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class LoadBalancedFrontendPolicy$ServerPolicy_Stub extends sapphire.policy.scalability.LoadBalancedFrontendPolicy.ServerPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public LoadBalancedFrontendPolicy$ServerPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        LoadBalancedFrontendPolicy$ServerPolicy_Stub other = (LoadBalancedFrontendPolicy$ServerPolicy_Stub) obj;
    ...
    public java.lang.Object onRPC(java.lang.String $param_String_1, java.util.ArrayList $param_ArrayList_2)
        ...
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public java.lang.Object sapphire.policy.scalability.LoadBalancedFrontendPolicy$ServerPolicy.onRPC(java.lang.String,java.util.ArrayList<java.lang.Object>) throws java.lang.Exception";
        $__params.add($param_String_1);
    ...
    public void onCreate(sapphire.policy.SapphirePolicy.SapphireGroupPolicy $param_SapphirePolicy$SapphireGroupPolicy_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.policy.scalability.LoadBalancedFrontendPolicy$ServerPolicy.onCreate(sapphire.policy.SapphirePolicy$SapphireGroupPolicy)";
