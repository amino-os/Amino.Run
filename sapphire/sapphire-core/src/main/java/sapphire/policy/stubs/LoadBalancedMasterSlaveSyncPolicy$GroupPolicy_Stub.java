/*
 * Stub for class sapphire.policy.scalability.LoadBalancedMasterSlaveSyncPolicy.GroupPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class LoadBalancedMasterSlaveSyncPolicy$GroupPolicy_Stub extends sapphire.policy.scalability.LoadBalancedMasterSlaveSyncPolicy.GroupPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public LoadBalancedMasterSlaveSyncPolicy$GroupPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        LoadBalancedMasterSlaveSyncPolicy$GroupPolicy_Stub other = (LoadBalancedMasterSlaveSyncPolicy$GroupPolicy_Stub) obj;
    ...
    // Implementation of renewLock(String)
    public boolean renewLock(java.lang.String $param_String_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public boolean sapphire.policy.scalability.LoadBalancedMasterSlaveBase$GroupBase.renewLock(java.lang.String)";
    ...
    public void removeServer(sapphire.policy.SapphirePolicy.SapphireServerPolicy $param_SapphirePolicy$SapphireServerPolicy_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.policy.DefaultSapphirePolicy$DefaultGroupPolicy.removeServer(sapphire.policy.SapphirePolicy$SapphireServerPolicy)";
    ...
    public void onCreate(sapphire.policy.SapphirePolicy.SapphireServerPolicy $param_SapphirePolicy$SapphireServerPolicy_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.policy.scalability.LoadBalancedMasterSlaveBase$GroupBase.onCreate(sapphire.policy.SapphirePolicy$SapphireServerPolicy)";
        $__params.add($param_SapphirePolicy$SapphireServerPolicy_1);
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
    ...
    // Implementation of obtainLock(String, long)
    public boolean obtainLock(java.lang.String $param_String_1, long $param_long_2) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public boolean sapphire.policy.scalability.LoadBalancedMasterSlaveBase$GroupBase.obtainLock(java.lang.String,long)";
        $__params.add($param_String_1);
    ...
    // Implementation of getSlave()
    public sapphire.policy.scalability.LoadBalancedMasterSlaveBase.ServerBase getSlave() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public sapphire.policy.scalability.LoadBalancedMasterSlaveBase$ServerBase sapphire.policy.scalability.LoadBalancedMasterSlaveBase$GroupBase.getSlave()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
        ...
        return ((sapphire.policy.scalability.LoadBalancedMasterSlaveBase.ServerBase) $__result);
    }
    ...
    // Implementation of getRandomServer()
    public sapphire.policy.scalability.LoadBalancedMasterSlaveBase.ServerBase getRandomServer() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public sapphire.policy.scalability.LoadBalancedMasterSlaveBase$ServerBase sapphire.policy.scalability.LoadBalancedMasterSlaveBase$GroupBase.getRandomServer()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
    ...
    // Implementation of getMaster()
    public sapphire.policy.scalability.LoadBalancedMasterSlaveBase.ServerBase getMaster() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public sapphire.policy.scalability.LoadBalancedMasterSlaveBase$ServerBase sapphire.policy.scalability.LoadBalancedMasterSlaveBase$GroupBase.getMaster()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
