/*
 * Stub for class sapphire.policy.scalability.LoadBalancedMasterSlaveSyncPolicy.ServerPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class LoadBalancedMasterSlaveSyncPolicy$ServerPolicy_Stub extends sapphire.policy.scalability.LoadBalancedMasterSlaveSyncPolicy.ServerPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public LoadBalancedMasterSlaveSyncPolicy$ServerPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        LoadBalancedMasterSlaveSyncPolicy$ServerPolicy_Stub other = (LoadBalancedMasterSlaveSyncPolicy$ServerPolicy_Stub) obj;
    ...
    // Implementation of syncObject(Serializable, long)
    public void syncObject(java.io.Serializable $param_Serializable_1, long $param_long_2) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.policy.scalability.LoadBalancedMasterSlaveSyncPolicy$ServerPolicy.syncObject(java.io.Serializable,long)";
        $__params.add($param_Serializable_1);
    ...
    public void start() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.policy.scalability.LoadBalancedMasterSlaveSyncPolicy$ServerPolicy.start()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
    ...
    // Implementation of onRPC(MethodInvocationRequest)
    public sapphire.policy.scalability.masterslave.MethodInvocationResponse onRPC(sapphire.policy.scalability.masterslave.MethodInvocationRequest $param_MethodInvocationRequest_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public sapphire.policy.scalability.masterslave.MethodInvocationResponse sapphire.policy.scalability.LoadBalancedMasterSlaveSyncPolicy$ServerPolicy.onRPC(sapphire.policy.scalability.masterslave.MethodInvocationRequest)";
        $__params.add($param_MethodInvocationRequest_1);
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
        ...
        return ((sapphire.policy.scalability.masterslave.MethodInvocationResponse) $__result);
    }
    ...
    public void onCreate(sapphire.policy.SapphirePolicy.SapphireGroupPolicy $param_SapphirePolicy$SapphireGroupPolicy_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.policy.scalability.LoadBalancedMasterSlaveSyncPolicy$ServerPolicy.onCreate(sapphire.policy.SapphirePolicy$SapphireGroupPolicy)";
    ...
    // Implementation of handleReplication(ReplicationRequest)
    public sapphire.policy.scalability.masterslave.ReplicationResponse handleReplication(sapphire.policy.scalability.masterslave.ReplicationRequest $param_ReplicationRequest_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public sapphire.policy.scalability.masterslave.ReplicationResponse sapphire.policy.scalability.LoadBalancedMasterSlaveSyncPolicy$ServerPolicy.handleReplication(sapphire.policy.scalability.masterslave.ReplicationRequest)";
        $__params.add($param_ReplicationRequest_1);
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
        ...
        return ((sapphire.policy.scalability.masterslave.ReplicationResponse) $__result);
    }

    // Implementation of getServerId()
    public java.lang.String getServerId() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public java.lang.String sapphire.policy.scalability.LoadBalancedMasterSlaveBase$ServerBase.getServerId()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
