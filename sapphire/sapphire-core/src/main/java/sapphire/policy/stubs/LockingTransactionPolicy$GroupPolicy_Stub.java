/*
 * Stub for class sapphire.policy.serializability.LockingTransactionPolicy.GroupPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class LockingTransactionPolicy$GroupPolicy_Stub extends sapphire.policy.serializability.LockingTransactionPolicy.GroupPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public LockingTransactionPolicy$GroupPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        LockingTransactionPolicy$GroupPolicy_Stub other = (LockingTransactionPolicy$GroupPolicy_Stub) obj;
