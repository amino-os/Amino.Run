/*
 * Stub for class sapphire.policy.serializability.LockingTransactionPolicy.ServerPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class LockingTransactionPolicy$ServerPolicy_Stub extends sapphire.policy.serializability.LockingTransactionPolicy.ServerPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public LockingTransactionPolicy$ServerPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        LockingTransactionPolicy$ServerPolicy_Stub other = (LockingTransactionPolicy$ServerPolicy_Stub) obj;
    ...
    // Implementation of syncObject(UUID, Serializable)
    public void syncObject(java.util.UUID $param_UUID_1, java.io.Serializable $param_Serializable_2) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.policy.cache.CacheLeasePolicy$CacheLeaseServerPolicy.syncObject(java.util.UUID,java.io.Serializable)";
    ...
    // Implementation of releaseLease(UUID)
    public void releaseLease(java.util.UUID $param_UUID_1)
            throws java.lang.Exception {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.policy.cache.CacheLeasePolicy$CacheLeaseServerPolicy.releaseLease(java.util.UUID) throws java.lang.Exception";
        $__params.add($param_UUID_1);
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
    ...
    // Implementation of getLease(long)
    public sapphire.policy.cache.CacheLeasePolicy.CacheLease getLease(long $param_long_1)
            throws java.lang.Exception {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public sapphire.policy.cache.CacheLeasePolicy$CacheLease sapphire.policy.cache.CacheLeasePolicy$CacheLeaseServerPolicy.getLease(long) throws java.lang.Exception";
    ...
    // Implementation of getLease(UUID, long)
    public sapphire.policy.cache.CacheLeasePolicy.CacheLease getLease(java.util.UUID $param_UUID_1, long $param_long_2)
            throws java.lang.Exception {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public sapphire.policy.cache.CacheLeasePolicy$CacheLease sapphire.policy.cache.CacheLeasePolicy$CacheLeaseServerPolicy.getLease(java.util.UUID,long) throws java.lang.Exception";
        $__params.add($param_UUID_1);
