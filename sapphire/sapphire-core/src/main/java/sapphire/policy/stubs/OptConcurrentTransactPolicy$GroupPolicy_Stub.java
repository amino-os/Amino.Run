/*
 * Stub for class sapphire.policy.serializability.OptConcurrentTransactPolicy.GroupPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class OptConcurrentTransactPolicy$GroupPolicy_Stub extends sapphire.policy.serializability.OptConcurrentTransactPolicy.GroupPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public OptConcurrentTransactPolicy$GroupPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        OptConcurrentTransactPolicy$GroupPolicy_Stub other = (OptConcurrentTransactPolicy$GroupPolicy_Stub) obj;
