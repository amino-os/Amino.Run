/*
 * Stub for class sapphire.policy.checkpoint.periodiccheckpoint.PeriodicCheckpointPolicy.GroupPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class PeriodicCheckpointPolicy$GroupPolicy_Stub extends sapphire.policy.checkpoint.periodiccheckpoint.PeriodicCheckpointPolicy.GroupPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public PeriodicCheckpointPolicy$GroupPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        PeriodicCheckpointPolicy$GroupPolicy_Stub other = (PeriodicCheckpointPolicy$GroupPolicy_Stub) obj;
