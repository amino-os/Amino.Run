/*
 * Stub for class sapphire.policy.serializability.SerializableRPCPolicy.GroupPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class SerializableRPCPolicy$GroupPolicy_Stub extends sapphire.policy.serializability.SerializableRPCPolicy.GroupPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public SerializableRPCPolicy$GroupPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        SerializableRPCPolicy$GroupPolicy_Stub other = (SerializableRPCPolicy$GroupPolicy_Stub) obj;
