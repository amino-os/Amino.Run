/*
 * Stub for class sapphire.policy.ShiftPolicy.ShiftGroupPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class ShiftPolicy$ShiftGroupPolicy_Stub extends sapphire.policy.ShiftPolicy.ShiftGroupPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public ShiftPolicy$ShiftGroupPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        ShiftPolicy$ShiftGroupPolicy_Stub other = (ShiftPolicy$ShiftGroupPolicy_Stub) obj;
