/*
 * Stub for class sapphire.policy.transaction.TwoPCCohortPolicy.TwoPCCohortGroupPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class TwoPCCohortPolicy$TwoPCCohortGroupPolicy_Stub extends sapphire.policy.transaction.TwoPCCohortPolicy.TwoPCCohortGroupPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public TwoPCCohortPolicy$TwoPCCohortGroupPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        TwoPCCohortPolicy$TwoPCCohortGroupPolicy_Stub other = (TwoPCCohortPolicy$TwoPCCohortGroupPolicy_Stub) obj;
