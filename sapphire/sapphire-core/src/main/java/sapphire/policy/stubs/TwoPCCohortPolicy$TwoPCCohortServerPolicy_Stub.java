/*
 * Stub for class sapphire.policy.transaction.TwoPCCohortPolicy.TwoPCCohortServerPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class TwoPCCohortPolicy$TwoPCCohortServerPolicy_Stub extends sapphire.policy.transaction.TwoPCCohortPolicy.TwoPCCohortServerPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public TwoPCCohortPolicy$TwoPCCohortServerPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        TwoPCCohortPolicy$TwoPCCohortServerPolicy_Stub other = (TwoPCCohortPolicy$TwoPCCohortServerPolicy_Stub) obj;
