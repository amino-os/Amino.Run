/*
 * Stub for class sapphire.policy.transaction.TwoPCCoordinatorPolicy.TwoPCCoordinatorGroupPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class TwoPCCoordinatorPolicy$TwoPCCoordinatorGroupPolicy_Stub extends sapphire.policy.transaction.TwoPCCoordinatorPolicy.TwoPCCoordinatorGroupPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public TwoPCCoordinatorPolicy$TwoPCCoordinatorGroupPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        TwoPCCoordinatorPolicy$TwoPCCoordinatorGroupPolicy_Stub other = (TwoPCCoordinatorPolicy$TwoPCCoordinatorGroupPolicy_Stub) obj;
