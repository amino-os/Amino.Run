/*
 * Stub for class sapphire.policy.transaction.TwoPCExtResourceCohortPolicy.TwoPCExtResourceCohortGroupPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class TwoPCExtResourceCohortPolicy$TwoPCExtResourceCohortGroupPolicy_Stub extends sapphire.policy.transaction.TwoPCExtResourceCohortPolicy.TwoPCExtResourceCohortGroupPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public TwoPCExtResourceCohortPolicy$TwoPCExtResourceCohortGroupPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        TwoPCExtResourceCohortPolicy$TwoPCExtResourceCohortGroupPolicy_Stub other = (TwoPCExtResourceCohortPolicy$TwoPCExtResourceCohortGroupPolicy_Stub) obj;
