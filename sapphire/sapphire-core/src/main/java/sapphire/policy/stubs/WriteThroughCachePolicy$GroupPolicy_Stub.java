/*
 * Stub for class sapphire.policy.cache.WriteThroughCachePolicy.GroupPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class WriteThroughCachePolicy$GroupPolicy_Stub extends sapphire.policy.cache.WriteThroughCachePolicy.GroupPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public WriteThroughCachePolicy$GroupPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        WriteThroughCachePolicy$GroupPolicy_Stub other = (WriteThroughCachePolicy$GroupPolicy_Stub) obj;
