/*
 * Stub for class sapphire.policy.cache.WriteThroughCachePolicy.ServerPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class WriteThroughCachePolicy$ServerPolicy_Stub extends sapphire.policy.cache.WriteThroughCachePolicy.ServerPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public WriteThroughCachePolicy$ServerPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        WriteThroughCachePolicy$ServerPolicy_Stub other = (WriteThroughCachePolicy$ServerPolicy_Stub) obj;
    ...
    public sapphire.common.AppObject getObject() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public sapphire.common.AppObject sapphire.policy.cache.WriteThroughCachePolicy$ServerPolicy.getObject()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
