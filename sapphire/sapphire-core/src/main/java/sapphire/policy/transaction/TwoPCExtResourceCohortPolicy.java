...
public class TwoPCExtResourceCohortPolicy extends TwoPCCohortPolicy {
    ...
    public static class TwoPCExtResourceCohortServerPolicy extends TwoPCCohortServerPolicy {
        public TwoPCExtResourceCohortServerPolicy() {
            ...
            internalTransactionManager.setValidator(new NonconcurrentTransactionValidator(this.sapphire_getAppObject(), this.sandboxProvider));
            this.setTransactionManager(new ExtResourceTransactionManager(this.sandboxProvider, internalTransactionManager));
        }
    }
