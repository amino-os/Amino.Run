...
public class Server
    ...
    class Leader {
         ...
         * @throws Exception either an exception thrown by the method invocation when applied
         *     locally, or a RAFTException indicating why the operation could not be applied.
         */
