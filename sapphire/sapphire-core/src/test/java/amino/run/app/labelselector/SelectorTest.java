...
public class SelectorTest {
    ...
    public void setUp() throws Exception {
        ...
        req1 = new Requirement("key1", Requirement.Equal, new ArrayList<>(Arrays.asList("value1")));
        req2 = new Requirement("key2", Requirement.Exists, new ArrayList<>());
        req3 = new Requirement("key2", Requirement.NotIn, new ArrayList<>(Arrays.asList("value1")));
        req4 =
                new Requirement(
                        "key1", Requirement.In, new ArrayList<>(Arrays.asList("value1", "value5")));
        req5 =
                new Requirement(
                        "key1", Requirement.In, new ArrayList<>(Arrays.asList("value2", "value5")));
    }
