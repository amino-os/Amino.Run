...
public class ExplicitMigrationPolicyTest {
    ...
    public void retryRegularRPCFromClientTimeoutCaseVerifyException() throws Exception {
        ...
        when(mockServerPolicy.onRPC(methodName, noParams, methodName, noParams))
        ...
        verify(mockServerPolicy, times(7)).onRPC(methodName, noParams, methodName, noParams);
    ...
    public void retryRegularRPCFromClientSuccessBeforeTimeoutCase() throws Exception {
        ...
        // decide the number of exponential backoffs
        verify(mockServerPolicy, times(3)).onRPC(methodName, noParams, methodName, noParams);
    ...
    public void basicExplicitMigration() throws Exception {
        ...
        this.client.onRPC(explicitMigrateObject, oneParam, explicitMigrateObject, oneParam);
        verify(this.server).onRPC(explicitMigrateObject, oneParam, explicitMigrateObject, oneParam);
    ...
    public void retryMigrateObjectRPCFromClientTimeoutCaseVerifyRPCCalls() throws Exception {
        ...
        verify(this.server, times(7))
                .onRPC(explicitMigrateObject, oneParam, explicitMigrateObject, oneParam);
