...
public class ExplicitCheckpointPolicyTest {
    ...
    public void basicSaveCheckpoint() throws Exception {
        String methodName =
                "public void sapphire.policy.checkpoint.explicitcheckpoint.ExplicitCheckpointerImpl.saveCheckpoint() throws java.lang.Exception";
        this.client.onRPC(methodName, noParams);
        verify(this.server).onRPC(methodName, noParams);
    ...
    public void saveAndRestoreCheckpoint() throws Exception {
        String
                saveMethodName =
                        "public void sapphire.policy.checkpoint.explicitcheckpoint.ExplicitCheckpointerImpl.saveCheckpoint() throws java.lang.Exception",
                restoreMethodName =
                        "public void sapphire.policy.checkpoint.explicitcheckpoint.ExplicitCheckpointerImpl.restoreCheckpoint() throws java.lang.Exception",
                setMethodName =
                        "public void sapphire.policy.checkpoint.explicitcheckpoint.ExplicitCheckpointerTest.setI(int)",
                getMethodName =
                        "public int sapphire.policy.checkpoint.explicitcheckpoint.ExplicitCheckpointerTest.getI()";
