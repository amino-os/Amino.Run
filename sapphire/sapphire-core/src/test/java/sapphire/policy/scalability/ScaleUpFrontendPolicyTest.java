...
public class ScaleUpFrontendPolicyTest {
    ...
    @ScaleUpFrontendPolicy.ScaleUpFrontendPolicyConfigAnnotation(replicationRateInMs = 20, loadbalanceConfig = @LoadBalancedFrontendPolicy.LoadBalancedFrontendPolicyConfigAnnotation(maxconcurrentReq = 2, replicacount = 2))
    ...
    public static class Server_Stub extends ScaleUpFrontendPolicy.ServerPolicy implements KernelObjectStub  {
    ...
    public void setUp() throws Exception {
        ...
        this.server1 = (ScaleUpFrontendPolicy.ServerPolicy) PowerMockito.spy(KernelObjectFactory.create(Server_Stub.class.getName()));
        ...
        final KernelObjectStub spiedReplicaServerStub2 = PowerMockito.spy(KernelObjectFactory.create(Server_Stub.class.getName()));
        final KernelObjectStub spiedReplicaServerStub3 = PowerMockito.spy(KernelObjectFactory.create(Server_Stub.class.getName()));
        mockStatic(KernelObjectFactory.class);
        PowerMockito.when(KernelObjectFactory.create(anyString())).thenAnswer(new Answer<KernelObjectStub>() {
            int i = 0;
            @Override
            public KernelObjectStub answer(InvocationOnMock invocation) throws Throwable {
                ...
                ((SapphirePolicy.SapphireServerPolicy)stub).$__initialize(appObject);
                ((SapphirePolicy.SapphireServerPolicy)stub).onCreate(group, SO.class.getAnnotations());
                return stub;
            }
        });
        ...
        doNothing().when((ScaleUpFrontendPolicy.ServerPolicy)spiedReplicaServerStub2).sapphire_deleteKernelObject();
        doNothing().when((ScaleUpFrontendPolicy.ServerPolicy)spiedReplicaServerStub3).sapphire_deleteKernelObject();

    }

    @Test
    public void clientTest() throws Exception {
        String methodName = "public int sapphire.policy.scalability.ScaleUpFrontendPolicyTest$SO.getCallNumber()";
        ArrayList<Object> params = new ArrayList<Object>();

        AtomicInteger syncCtrCurr = (AtomicInteger) extractFieldValueOnInstance(this.client, "replicaListSyncCtr");
        ...
        syncCtrCurr = (AtomicInteger) extractFieldValueOnInstance(this.client, "replicaListSyncCtr");
        assertEquals(1, syncCtrCurr.get());

        ArrayList<SapphirePolicy.SapphireServerPolicy> replicas = (ArrayList<SapphirePolicy.SapphireServerPolicy>) extractFieldValueOnInstance(this.client, "replicaList");
    ...
    public void serverScaleUpTest() throws Exception {
        final String methodName = "public int sapphire.policy.scalability.ScaleUpFrontendPolicyTest$SO.getCallNumber()";
